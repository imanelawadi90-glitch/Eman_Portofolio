...
export const portfolioVideos: PortfolioItem[] = [
  ...
  {
    id: 10,
    title: "كاهنة مصرية قديمة عايشة في جسد طفلة.. تناسخ الأرواح!!",
    publication: "Break",
    date: "May 2022",
    duration: "06:09",
    description: "قصة حياة البريطانية دوروثي إيدي، اللي اتغيرت حياتها تمامًا بسبب تناسخ الأرواح، وإدعائها بإن شخصية مصرية قديمة عايشه في جسمها وبتتكلم بلسانها، وازاي تم إثبات صحة كلامها بأكتر من طريقة.",
  ...
  {
    id: 16,
    title: "أجندة نتنياهو الخفية",
    publication: "Elkalamalaeh",
    date: "Dec 2023",
    duration: "00:59",
    description: "نتنياهو عنده أجندة خفية ورا كل اللي بيحصل في غزة، واللي بسببها مصمم يكمل في الحرب للنهاية، لحد ما يحقق كل أهدافه وخططه",
    videoUrl: "https://www.instagram.com/reel/C1SrycXN8Pf/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
    {
    id: 17,
    title: "الماية متعديش عالعطشان",
    publication: "Elkalamalaeh",
    date: "Dec 2023",
    duration: "01:09",
    description: "الماية اللي المفروض متعديش عالعطشان، جت لحد فلسطين واتاخدت منهم، وللأسف أزمة الفلسطينيين مع الماية مش جديدة ولا بدأت مع أحداث 7 أكتوبر.. إستهلاك فلسطينيين الضفة الغربية للماية في اليوم للفرد الواحد أقل بكتير من اللي منظمة الصحة العالمية حددته، وبيشتروها من إسرائيل بأضعاف تمنها، وفي غزة الوضع أصعب بكتير",
    videoUrl: "https://www.instagram.com/reel/C0Zq9kkL5pJ/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
  {
    id: 18,
    title: "مين اللي ورا جيفري إبستين؟",
    publication: "Elkalamalaeh",
    date: "Nov 2023",
    duration: "01:09",
    description: "فتح ملف جيفري إبستين من تاني، ومحاولة لكشف الستار عن الغموض اللي بيدور حوالين قضيته، والمتورطين معاه في أفعاله الإجرامية",
  ...
  {
    id: 19,
    title: "سرقة الجلود في مقابر الأرقام",
    publication: "Elkalamalaeh",
    date: "Nov 2023",
    duration: "01:34",
  ...
  },
  {
    ...
    videoUrl: "https://www.instagram.com/reel/C5_t987r55h/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
  {
    id: 21,
    title: "شركة آبل سبب في طلاق زوجين",
    publication: "Elkalamalaeh",
    date: "Jul 2024",
    duration: "00:42",
    description: "راجل بريطاني رفع قضية على شركة آبل، علشان كشفت خيانته اللي كان مخبيها بقاله سنين، وعاوزهم يدفعوله 6 ونص مليون دولار تعويض عن طلاقه",
    videoUrl: "https://www.instagram.com/reel/C9xVS3cN10O/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
  {
    id: 22,
    title: "خطر جديد بيهدد بنات مصر",
    publication: "Elkalamalaeh",
    date: "Apr 2025",
    duration: "01:15",
    description: "كارثة جديدة بتهدد بنات مصر، بسبب الذكاء الإصطناعي؛ فيديوهات مفبركة، وإبتزاز بأساليب مرعبة، والضحايا بيزيدوا كل يوم",
    videoUrl: "https://www.instagram.com/reel/DH52_y-sMTk/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
  {
    id: 23,
    title: "أزمة في الحرم بسبب تيكتوكر",
    publication: "Elkalamalaeh",
    date: "Mar 2025",
    duration: "01:04",
    description: "تيكتوكر مصري يخترق صحن الكعبة علشان ياخد لقطة، ويفضح نفسه بفيديو ممكن يدخله في مشاكل قانونية كبيرة",
    videoUrl: "https://www.instagram.com/reel/DHlX_IjN6iq/embed",
    tags: ["Elkalamalaeh"],
    featured: true,
  },
  
  {
    ...
    date: "Apr 2025",
    duration: "00:38",
    description: "الكاميرا اللي في بيتك ممكن تكون بتصورك وانت مش واخد بالك.. هاكرز بيخترقوا الكاميرات بطرق خبيثة، وبيبيعوا الفيديوهات على تليجرام، والمصيبة ان أغلب الضحايا من دول الخليج",
